...
from ltzf_api_client.models import Autor, Doktyp, Gremium, Parlament, Stationstyp
from ltzf_api_client.models import Dokument as PaZuFaDokument
from ltzf_api_client.types import UNSET, Unset

from scraper_BE.constants import FILE_BYTE_HASH_FILE_NAME, LAST_MODIFIED_FILE_NAME, SUMMARY_FILE_NAME, TEXT_FILE_NAME
from scraper_BE.pardok import AnyGesetzDokument, APrDokument, BaseGesetzDokument, DrsDokument, GVBlDokument, PlPrDokument
