...
from ltzf_api_client.api.vorgang import vorgang_put
from ltzf_api_client.models.vorgang import Vorgang
from scrapy.exceptions import DropItem

from scraper_BE.pipelines._base import ApiPipeline
