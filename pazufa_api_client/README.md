# ltzf-api-client
A client library for accessing LTZF API

## Usage
First, create a client:

```python
from ltzf_api_client import Client
...
```python
from ltzf_api_client import AuthenticatedClient
...
```python
from ltzf_api_client.models import MyDataModel
from ltzf_api_client.api.my_tag import get_my_data_model
from ltzf_api_client.types import Response
...
1. Any endpoint which did not have a tag will be in `ltzf_api_client.api.default`
