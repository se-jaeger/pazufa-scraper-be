# pazufa_api_client
A client library for accessing PaZuFa API

## Usage
First, create a client:

```python
from pazufa_api_client import Client
...
```python
from pazufa_api_client.models import MyDataModel
from pazufa_api_client.api.my_tag import get_my_data_model
from pazufa_api_client.types import Response
...
1. Any endpoint which did not have a tag will be in `pazufa_api_client.api.default`
