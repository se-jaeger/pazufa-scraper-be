...
def sync_detailed(
    ...
    *,
    ...
    Args:
        api_id (UUID):
        body (Dokument): A document. Could be a protocol, a Drucksache, a statement, ... For
            different objects, only certain properties are optional, which is a design flaw. \
