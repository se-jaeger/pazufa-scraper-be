...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/api/v2/sitzung/{sid}".format(sid=quote(str(sid), safe=""),),
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        sid (UUID):
        body (Sitzung): plenary session, committee session or committee hearing. A session is a
            hearing if experts are invited. Example: {'api_id':
            'b1a2c3d4-e5f6-7890-fedc-1234567890ab', 'titel': '143. Sitzung des Deutschen Bundestages',
            'termin': '2024-05-20T09:00:00+02:00', 'gremium': {'parlament': 'BT', 'wahlperiode': 20,
            'name': 'plenum'}, 'nummer': 143, 'public': True, 'link':
