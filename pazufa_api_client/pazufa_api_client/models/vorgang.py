...
@_attrs_define
class Vorgang:
    """ 'Master Object of the API. Wrapper type around stations. `Vorgang` describes not only legislative processes, but
    also small and big requests
        ...
        Attributes:
            api_id (UUID): Use UUID version 5 with your collector id as namespace Example:
            ...
            ressort (Ressort | Unset): Ressort, in which the Vorgang is associated with. Usually the name of a ministry
            sachgebiete (list[Sachgebiet] | Unset):
     """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ressort: Ressort | Unset
        if isinstance(_ressort,  Unset):
            ressort = UNSET
        else:
            ressort = Ressort(_ressort)
